...
// Displays overall training plan progress and the current week's daily plan
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Two circular progress bars: weeks completed vs. total, and workouts done vs. total
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Expanded(
                      child: circularPogressBar(
                        totalDone: widget.trainingPlan!.currentWeekNb
                            .toDouble(),
                    ...
                    Expanded(
                      child: circularPogressBar(
                        totalDone: widget.trainingPlan!.currentNbOfWorkouts
                            .toDouble(),
                ...
                // Current week — render each day's plan as a DailyPlanCard
                ListView.builder(
                  shrinkWrap: true,
                  physics: NeverScrollableScrollPhysics(),
                  padding: const EdgeInsets.symmetric(vertical: 8),
                  itemCount:
                      widget.trainingPlan!.currentWeeklyPlan.dailyPlans.length,
